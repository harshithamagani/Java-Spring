...
<main role="main" class="container">
  ...
  <c:forEach items="${order.orderProducts}" var="orderProduct">
    <tr>
      <td><img class="tumbnail" alt="" src="${orderProduct.product.imageUrl}">${orderProduct.product.name}</td>
...
<button type="submit" onclick="location.href='/lotus/order'" class="btn btn-primary">Place Order</button>
  </div>
